      ...
      <div class="row justify-content-center">
         <div class="col-md-6 col-lg-4">
            <div class="login-wrap py-5">
               ...
               <form action="index.php?route=HandleUser&action=handle_register" class="login-form" method="POST">
                  <!-- Email Address -->
               ...
               <div class="w-100 text-center mt-4 text">
                  ...
                  <a href="index.php?route=HandleUser&action=view_login">LOG IN</a>
               </div>
            </div>
         </div>
      </div>
