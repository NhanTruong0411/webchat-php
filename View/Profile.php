...
<form action="index.php?controller=UserController&action=handle_edit_profile" method="POST" enctype="multipart/form-data">
   ...
   <div class="container text-center profile_main">
      <div class="row justify-content-center">
         <div class="mt-3 mb-3 text-center w-75">
            ...
            <div class="form-group row">
               ...
               <div class="col-sm-8">
                  <input type="password" class="form-control" style="color: #000 !important;" id="inputPassword" name="old_pass">
               </div>
            </div>
            <!-- new password -->
            <div class="form-group row">
               ...
               <div class="col-sm-8">
                  <input type="password" class="form-control" style="color: #000 !important;" id="inputNewPassword" name="new_pass">
               </div>
            </div>
            ...
            <div class="form-group row">
               ...
               <div class="col-sm-8">
                  <input type="password" class="form-control" style="color: #000 !important;" id="inputConfirmNewPassword" name="c_new_pass">
               </div>
            </div>
         </div>
      </div>
      <div class="row justify-content-center pb-5">
         ...
         <a type="reset" href="index.php?ctrl=UserController&action=view_profile" class="btn btn-lg btn-danger text-lg-center mx-3">Reset</a>
         <a href="index.php?ctrl=ChatController&action=view_chatbox" class="btn btn-lg btn-warning text-lg-center">Back to chat</a>
      </div>
   </div>
</form>
