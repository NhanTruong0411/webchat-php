...
<div class="row">
   <div class="col-md-2 col-sm-3 p-0 text-center">
      <div class="card d-flex flex-column" style="height: 100vh !important; background-color: #F9AA33 !important;">
         ...
         <a href="index.php?ctrl=UserController&action=view_profile" class="mt-2 mb-2 text-white">User list</a>
               ...
               <tbody>
                  ...
                  ?>
                     ...
                     <tr>
                        ...
                        <td>
                           <a href="" class="btn btn-sm btn-info text-lg-center text-white">View</a>
                           <a href="" class="btn btn-sm btn-warning text-lg-center text-dark ml-2">Update</a>
                           <a href="" class="btn btn-sm btn-danger text-lg-center text-white ml-2">Delete</a>
                        </td>
                     </tr>
                  <?php } }?>
               </tbody>
